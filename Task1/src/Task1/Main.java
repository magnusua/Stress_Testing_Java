 ...
 * конвертировать число из любой системы исчисления в любую другую
...
public class Main {
    ...
    public static String itoBase(String nb, @NotNull Optional<String> baseSrc, String baseDst) {
        int n = 0;
        ...
        if (n <= 0) return "0"; //decimal2Hex
        int b = baseDst.length();
        String hex = "";
        while (n > 0) {
            int digit = n % b;              // rightmost digit
    ...
    public static void Usage() {
        System.out.println("Usage:" + System.lineSeparator() +
                ...
                "  - где nb это подаваемое число, base система исчисления."
                + System.lineSeparator() + "Или " + System.lineSeparator() +
                "nb baseSrc baseDst" + System.lineSeparator() +
                "  - где baseSrc " +
                "- система счисления nb, а baseDst - целевая система" + System.lineSeparator() +
